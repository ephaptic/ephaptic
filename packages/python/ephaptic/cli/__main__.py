...
def load_ephaptic(import_name: str) -> Ephaptic:
    ...
    if ":" not in import_name: import_name += ":app" # default: expect app to be named `app` inside the file
...
@app.command()
def generate(
    app: str = typer.Argument('app:app', help="The import string (e.g. `app:app`)"),
